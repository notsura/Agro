...
import { ArrowRight, Leaf, ShieldCheck, Zap, HeartHandshake, MousePointer2 } from 'lucide-react';
        ...
        <div>
                    ...
                    <div className="hero-section" style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 'var(--space-8)', alignItems: 'center' }}>
                        ...
                        >
                            ...
                            <motion.h1 variants={itemVariants} style={{ fontSize: '5rem', marginBottom: 'var(--space-5)', letterSpacing: '-0.02em' }}>
                                Cultivating the <br />
                                <span className="serif" style={{ color: 'var(--primary)', fontStyle: 'italic' }}>Future</span> of Farming
                            </motion.h1>
                            ...
                            <motion.p variants={itemVariants} style={{ fontSize: '1.25rem', color: 'var(--text-muted)', marginBottom: 'var(--space-7)', lineHeight: 1.6, maxWidth: '580px' }}>
                                AgroAssist empowers farmers with precision diagnostics, real-time market data, and expert climate advisories to maximize yield and ensure sustainable livelihoods.
                            </motion.p>
                            ...
                            <motion.div variants={itemVariants} style={{ marginTop: 'var(--space-8)', display: 'flex', alignItems: 'center', gap: 'var(--space-4)' }}>
                                ...
                                <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                                    <span style={{ fontWeight: 800, color: 'var(--text)' }}>12,000+</span> farmers joined this month
                                </div>
                            </motion.div>
                        </motion.div>
                        ...
                        >
                            ...
                            >
                                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                                    ...
                                    <div>
                                        <div style={{ fontWeight: 800, fontSize: '1.1rem' }}>AI Powered</div>
                                        <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Instant Diagnostics</div>
                                    </div>
                                </div>
                            </motion.div>
                        </motion.div>
            ...
            <section className="section-padding" style={{ background: 'white' }}>
                <div className="main-container">
                    <div style={{ textAlign: 'center', marginBottom: 'var(--space-8)' }}>
                        <h2 style={{ fontSize: '3rem', marginBottom: 'var(--space-3)' }}>Designed for Growth</h2>
                        <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto' }}>Agriculture meets advanced technology. We provide the tools you need to succeed in the modern era.</p>
                    </div>

                    <div className="grid-auto" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
                        {[
                            { title: 'Crop Advisor', desc: 'Precision diagnostics & seasonal growth roadmaps.', icon: <Zap size={32} />, path: '#advisor', color: 'var(--primary)', bg: 'var(--primary-light)' },
                            { title: 'Crop Library', desc: 'Detailed biology & cultivation guides for every variety.', icon: <Leaf size={32} />, path: '#crops', color: '#0984e3', bg: '#e1f5ff' },
                            { title: 'Expert Hub', desc: 'Real-time 1-on-1 chat with agricultural specialists.', icon: <MousePointer2 size={32} />, path: '#chat', color: '#ff922b', bg: '#fff4e6' },
                            { title: 'Market Logic', desc: 'Live price indexing & smart supply chain insights.', icon: <ShieldCheck size={32} />, path: '#market', color: '#e84393', bg: '#fce4ec' }
                        ].map((stat, i) => (
                            <motion.div
                                key={i}
                                className="card"
            ...
            <footer style={{ background: 'white', padding: 'var(--space-8) 0', borderTop: '1px solid var(--border)' }}>
                <div className="main-container" style={{ textAlign: 'center' }}>
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', marginBottom: 'var(--space-7)' }}>© 2026 AgroAssist Platform. Empowering Farmers Worldwide.</p>
